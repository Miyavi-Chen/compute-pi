...
default: $(GIT_HOOKS) computepi.o
	...
	$(CC) $(CFLAGS) computepi.o time_test.c -DMONTECARLO -o time_test_motecarlo
	$(CC) $(CFLAGS) computepi.o time_test.c -DMONTECARLO_PTHREAD_8 -o time_test_montecarlo_pthread
...
check: default
	...
	time ./time_test_motecarlo
	time ./time_test_montecarlo_pthread

gencsv: default
	for i in `seq 500 500 25000`; do \
		printf "%d," $$i;\
